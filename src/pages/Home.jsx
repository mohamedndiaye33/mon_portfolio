...
function Home() {
  return (
    ...
    transition={{ delay: 0.5, duration: 0.8,}}  className="text-center md:text-left max-w-xl">
      ...
      <div>
        <motion.img
          src={ONE}
          alt="Mohamed Ndiaye"
          className="w-64 h-68 object-cover rounded-full border-4 border-blue-500 shadow-blue-500 hover:shadow-lg  transition-shadow hover:shadow-blue-700"
